            ...
            <form method="post">
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md-7">
                            <label for="exampleInputLastName">Reason</label>
                            <textarea class="form-control" placeholder="Reason" name="reason" required=""></textarea>
                        </div>
                        <div class="col-md-7">
                            <label for="exampleInputLastName">Time Zone</label>
                ...
                <button type="submit" class="btn btn-success btn-block col-md-7" name="submit">Request Healing</button>
            </form>
            <?php
