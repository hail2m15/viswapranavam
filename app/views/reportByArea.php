    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="home">HOME</a>&nbsp;/&nbsp;REPORT BY AREA
            </li>
        ...
        <div class="card-body">
            ...
            <form class="form-text" method="post" >
                <div class="col-md-3">
                   ...
                   <?php
                    if ($data['area']) {
                        echo '<input class="form-control" type="text" name="area" id="area" value="'.$data['area'].'" required>';
                    } else {
                        echo '<input class="form-control" type="text" name="area" id="area" required>';
                    }
                    ?>
                </div>
                <div class="col-md-3">
