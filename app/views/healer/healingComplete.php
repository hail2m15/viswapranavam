                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="col-md-12">
                                        <form method="post">
                                            <input name="id" value="<?php echo $data['details']->id ?>" hidden="">
                                            <div class="form-group">
                                                <label>Click 'Reschedule' to create a new healing session</label>

                                            </div><a class="nav-link"  data-toggle="modal" data-target="#completeModal">
                                                <button type="submit" class="btn btn-warning btn-block col-md-7 pull-right" name="complete">Rescedule</button></a>
                                        </form>
                                    </div>     
                                </form>
                            </div>
    ...
    <form method="post">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Select the date and time to rescedule.
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Date :</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Time(HH:mm) :</label>
                                <input class="form-control" name="time" id="time1" placeholder="HH:mm">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <input name="tid" value="<?php echo $data['details']->id ?>" hidden="">
                    <input class="btn btn-success" type="submit" name="rescedule" value="OK">
